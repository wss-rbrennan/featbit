...
namespace Infrastructure.Scaling.Manager
{
    public class RedisManager
    {
        ...
        private RedisManager(ILogger<RedisManager> logger, IConfiguration configuration)
        {
        ...
        public static RedisManager GetInstance(ILogger<RedisManager> logger, IConfiguration? configuration = null)
        {
            if (_instance == null)
            {
                if (configuration == null)
                {
                    throw new ArgumentNullException(nameof(configuration), "Configuration is required for first initialization");
                }
                _instance = new RedisManager(logger, configuration);
            }
            return _instance;
        }
